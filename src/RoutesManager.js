...
import { Route, Navigate, useLocation, Routes, BrowserRouter } from "react-router";
  ...
  return (
        <div className="content d-flex">
          ...
          <div
            ...
            >
                <Routes>
                  <Route exact path="/" element={ <Navigate to="/play"/> } />
                  <Route path="/play" element={ <Play /> } />
                  <Route path="/transaction-history" element={ <TransactionHistory /> } />
                  <Route path="/tak-stak" element={ <TakStaking /> } />
                  <Route path="/monkey-earning" element={ <MonkeyEarning /> } />
                  <Route path="/bookearning" element={ <ComicBookearnings /> } />
...
export default connect(mapStateToProps, {setPopUp})(RoutesManager)
